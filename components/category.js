  ...
  return (
    <>
      <header className={`category-container ${props.rootClassName} `}>
        <header data-thq="thq-navbar" className="category-navbar-interactive">
          <div data-thq="thq-navbar-nav" className="category-desktop-menu">
            <nav className="category-links1">
              <a
                href={props.link1Url}
                className="thq-body-small thq-link category-link11"
              >
                {props.link1 ?? (
                  <Fragment>
              ...
              <a
                href={props.link2Url}
                className="thq-body-small thq-link category-link21"
              >
                {props.link2 ?? (
                  <Fragment>
              ...
              <a
                href={props.link3Url}
                className="thq-body-small thq-link category-link31"
              >
                {props.link3 ?? (
                  <Fragment>
              ...
              <a
                href={props.link4Url}
                className="thq-body-small thq-link category-link41"
              >
                {props.link4 ?? (
                  <Fragment>
              ...
              <a
                href={props.link5Url}
                className="thq-body-small thq-link category-link51"
              >
                {props.link5 ?? (
                  <Fragment>
          ...
          <div data-thq="thq-burger-menu" className="category-burger-menu">
            <svg viewBox="0 0 1024 1024" className="category-icon10">
              <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
            </svg>
          </div>
          <div data-thq="thq-mobile-menu" className="category-mobile-menu">
            <div className="category-nav">
              <div className="category-top">
                ...
                />
                <div data-thq="thq-close-menu" className="category-close-menu">
                  <svg viewBox="0 0 1024 1024" className="category-icon12">
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              <nav className="category-links2">
